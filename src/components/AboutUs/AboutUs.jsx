...
const AboutUs = () => {
  return (
    <div className="w-full px-6 md:px-12 lg:px-35 2xl:px-50 py-6 md:py-8 lg:py-10 2xl:py-14 flex flex-col lg:flex-row items-center justify-between bg-[#ECEAE3] gap-10 md:gap-12">
