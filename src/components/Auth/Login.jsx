  ...
  return (
    <div className="h-[92vh] md:h-[91vh] lg:h-[90vh] 2xl:h-[89vh] w-full authBg flex items-center justify-center px-6 md:px-12 lg:px-35 2xl:px-50">
      <div className="w-full md:w-[65%] lg:w-[45%] 2xl:w-[40%]  p-6 md:p-8 lg:p-10 bg-[#eceae3bd] flex flex-col gap-2 md:gap-3 lg:gap-4 2xl:gap-5">
        ...
        <form className="flex flex-col gap-2 md:gap-3 lg:gap-4 2xl:gap-5">
          <input
          ...
          <button className="text-[16px] md:text-[17px] lg:text-[18px] 2xl:text-[20px] py-2 px-3 lg:px-4 w-full text-[#242222] bg-[#E3B577] hover:bg-[#e9a956] transition-all duration-300 flex items-center justify-center gap-1 md:gap-2 group">
            <span>Login</span>
